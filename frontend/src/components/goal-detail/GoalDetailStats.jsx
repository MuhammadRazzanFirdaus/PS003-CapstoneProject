...
function StatusBadge({ status, isNotAchieved }) {
  if (isNotAchieved && status !== "completed") {
    return (
    ...
    <div className="flex flex-col gap-3">
      ...
      >
        ...
        <div className="flex-1 pl-6">
          ...
          <StatusBadge status={goal.status} isNotAchieved={!onTrack} />
        </div>
      </motion.div>
    </div>
  );
